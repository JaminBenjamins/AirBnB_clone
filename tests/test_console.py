#!/usr/bin/python3
"""Unittests definition for console.py.
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Tests to check HBNB command interpreter prompting."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Tests to verify HBNB command interpreter help messages."""
    ...
    def test_help_EOF(self):
        h = "Send EOF signal to terminate the program."
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Tests to verify exiting HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Tests to verify create in HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Tests to verify show in HBNB command interpreter."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Tests to verify destroy in HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Tests to verify all in HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Tests to verify update in HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Tests to verify count method in HBNB command interpreter."""
