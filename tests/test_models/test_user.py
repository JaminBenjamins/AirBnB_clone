...
class TestUser_instatiation(unittest.TestCase):
    """Unittest for testing instatiation of User class """

    def test_no_args_instatiates(self):
        self.assertEqual(User, type(User()))

    def test_new_instance_stored_in_objects(self):
        self.asserIn(User(), models.storage.all())
    ...
    def test_two_users_unique_ids(self):
        u1 = User()
        u2 = User()
        sef.assertNotEqual(u1.id, u2.id)
    ...
    def test_str_representation(self):
        ...
        usstr = us.__str__()
        self.assertIn("[User] (45900)", usstr)
        self.assertIn("'id': '45900'", usstr)
    ...
    class TestUser_to_dict(unittest.TestCase):
        """ Unittest for dictionary methods in user """
