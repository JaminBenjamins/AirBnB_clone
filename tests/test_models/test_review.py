#!/usr/bin/python3
"""Defination of unittests for models/review.py.
...
class TestReview_instantiation(unittest.TestCase):
    """Tests to verify Review class instantiation."""
...
class TestReview_save(unittest.TestCase):
    """Tests to verify Review class save method."""
...
class TestReview_to_dict(unittest.TestCase):
    """Tests to check Review class to_dict method."""
